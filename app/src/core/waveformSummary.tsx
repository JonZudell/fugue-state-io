...
export const ASharpBins = getFrequencyBins(
  [12.78, 25.56, 41.26, 82.52, 165.04, 233.08, 466.16, 932.33, 1864.66, 3729.31, 7458.62, 14917.24],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
export const BBins = getFrequencyBins(
  [15.45, 30.90, 61.79, 123.47, 246.94, 493.88, 987.77, 1975.53, 3951.07, 7902.13, 15804.26],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
export const CBins = getFrequencyBins(
  [16.85, 32.70, 65.41, 130.81, 261.63, 523.25, 1046.5, 2093.0, 4186.0, 8392.0, 16784.0],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
export const CSharpBins = getFrequencyBins(
  [18.35, 36.71, 73.42, 146.83, 293.66, 587.33, 1174.66, 2349.32, 4698.64, 9397.27, 18794.55],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
...
export const DSharpBins = getFrequencyBins(
  [23.12, 46.25, 92.50, 185.00, 369.99, 739.99, 1479.98, 2959.96, 5919.91, 11839.82, 23679.64],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
export const EBins = getFrequencyBins(
  [25.96, 51.91, 103.83, 207.65, 415.30, 830.61, 1661.22, 3322.44, 6644.88, 13289.75, 26579.51],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
...
export const FSharpBins = getFrequencyBins(
  [32.70, 65.41, 130.81, 261.63, 523.25, 1046.50, 2093.00, 4186.01, 8372.02, 16744.04, 33488.08],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
export const GBins = getFrequencyBins(
  [36.71, 73.42, 146.83, 293.66, 587.33, 1174.66, 2349.32, 4698.64, 9397.27, 18794.55, 37589.10],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
export const GSharpBins = getFrequencyBins(
  [41.20, 82.41, 164.81, 329.63, 659.26, 1318.51, 2637.02, 5274.04, 10548.08, 21096.16, 42192.32],
  SAMPLE_RATE,
  SAMPLE_BIN_SIZE,
);
