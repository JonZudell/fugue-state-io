...
class PhaseVocoderProcessor extends OverlapAddProcessor {
  ...
  applyHammingWindow(input) {
    for (var i = 0; i < this.blockSize; i++) {
      input[i] = input[i] * (0.54 - 0.46 * Math.cos(2 * Math.PI * i / this.blockSize));
    }
  }
